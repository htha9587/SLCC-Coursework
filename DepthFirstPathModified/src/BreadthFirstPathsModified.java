 ...
 *  @author Kevin Wayne
 */
public class BreadthFirstPathsModified {
     ...
     */
    public BreadthFirstPathsModified(Graph G, int s) {
     ...
     */
    public BreadthFirstPathsModified(Graph G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
        distTo = new int[G.V()];
        edgeTo = new int[G.V()];
    ...
    public static void main(String[] args) {
        In in = new In("http://algs4.cs.princeton.edu/41graph/tinyCG.txt");
        Graph G = new Graph(in);
        // StdOut.println(G);

        int s = 2;
        BreadthFirstPathsModified bfs = new BreadthFirstPathsModified(G, s);

        StdOut.println("Adjancency List:");
        for(int v = 0; v < G.V(); v++){
        	StdOut.printf("%d: ", v);
        	for(int adj : G.adj(v)){
        		StdOut.print(adj + "->");
        ...
        StdOut.println("Marked   EdgeTo   DistTo");
        for(int v = 0; v < G.V(); v++){
        	System.out.println(bfs.hasPathTo(v)+ "      " + bfs.edgeTo[v] + "         " + bfs.distTo(v));
        }
         System.out.println();
